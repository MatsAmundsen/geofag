  ...
  return (
    ...
    >
      ...
      <ul className="list-disc space-y-2 pl-6">
        ...
        <li>
          <strong>Fra omkring 35–40° til polene:</strong> mer energi ut enn inn. Permanent
          energiunderskudd (NASA, u.å.).
        </li>
      </ul>
      <p>
      ...
      <ul className="list-disc space-y-2 pl-6">
        ...
        <li>
          <strong>Sone:</strong> ikke en strek, men et belte med skyer og nedbør rundt kloden (NOAA,
          u.å.-b; Store norske leksikon, u.å.-b).
        </li>
      </ul>
      <p>
      ...
      <p>
        Derfor ligger Sahara, Den arabiske halvøy og Kalahari her (NOAA, u.å.-a). Sahara er ørken
        fordi lufta synker, ikke fordi det «mangler elver». Atacama ligger også i dette beltet, og
        blir enda tørrere av kald kyststrøm og Andes som leside.
      </p>
      ...
      <p>
        ...
        Fuktig luft fra Det indiske hav strømmer inn: <strong>sommermonsunen</strong> (NOAA,
        u.å.-b; Store norske leksikon, u.å.-d). Mellom 10° og 20° kommer og går ITCZ med årstiden. Det
        gir savanne: regntid og tørketid.
      </p>
      ...
      <div className="my-6 space-y-4 rounded-xl border border-border/80 bg-surface/50 p-5">
        <div>
          ...
          <p className="mt-1 text-sm text-foreground/90">
            ...
            og blir <strong>sørøstpassat</strong> (Store norske leksikon, u.å.-c; NOAA, u.å.-a).
          </p>
        </div>
      ...
      <p>
        ...
        fjell (Store norske leksikon, u.å.-e; Store norske leksikon, u.å.-f; Store norske leksikon,
        u.å.-g). Full føn-regning — 0,6 °C og 1,0 °C per 100 m — står i kapitlene om{" "}
        <Link to="/tema/hoytrykk-lavtrykk" className={lenke}>
          høytrykk og lavtrykk
        </Link>{" "}
        og{" "}
