...
function MilankovitchPage() {
  return (
    ...
    >
      ...
      <FigurePlaceholder
        id="fig-milankovitch-oversikt"
        heading="Figurplass: de tre syklusene sammen"
        label="Én oversiktsfigur med jorda i bane: eksentrisitet, aksehelning og presesjon merket med periodene 100 000, 41 000 og 23 000 / 19 000 år."
        caption="Skal vise de tre Milankovitch-parametrene i samme bilde, med periode og hva hver endrer. ID: fig-milankovitch-oversikt."
      />
      ...
      <FigurePlaceholder
        id="fig-eksentrisitet"
        heading="Figurplass: eksentrisitet"
        label="To ellipsebaner rundt sola: nesten sirkel (lav eksentrisitet) og tydelig ellipse (høy). Merk perihel og aphel, og at avstandsforskjellen vokser når ellipsen er mer avlang."
        caption="Skal vise hvordan banens form endrer avstanden til sola gjennom året. ID: fig-eksentrisitet."
      />
      ...
      <FigurePlaceholder
        id="fig-helning"
        heading="Figurplass: aksehelning"
        label="Jorda ved sommersolverv på nordlig halvkule, tegnet to ganger: helning 22,1° og 24,5°. Vis innstrålingen mot 65 °N og at høyere helning gir mer sommersol der."
        caption="Skal vise hvordan aksehelning styrer sommersol på høye nordlige bredder. ID: fig-helning."
      />
      ...
      <FigurePlaceholder
        id="fig-presesjon"
        heading="Figurplass: presesjon"
        label="To baner: nordlig sommer i perihel (sterk sommersol på 65 °N) versus nordlig sommer i aphel (svakere sommersol). Merk dagens situasjon: perihel i januar."
        caption="Skal vise presesjon som sesong mot perihel/aphel, ikke som «jorda snurrer baklengs». ID: fig-presesjon."
      />
      ...
      <FigurePlaceholder
        id="fig-innsolasjon-65n"
        heading="Figurplass: innstråling på 65 °N"
        label="Kurve over sommersol på 65 °N gjennom de siste 400 000 år, med glacialer og interglacialer under. Marker siste glacialmaksimum og holocen."
        caption="Skal vise at det er sommersol på 65 °N som matcher istidskurven — ikke global årsinnstråling. ID: fig-innsolasjon-65n."
      />
      ...
      <FigurePlaceholder
        id="fig-istid-faktorer"
        heading="Figurplass: istidsfaktorene"
        label="Flytskjema: bakteppe (land, lav bakgrunns-CO₂) → orbital utløser (svak 65 °N-sommer) → fukt og snø → albedo og CO₂ som forsterkere → innlandsis. Skill utløser fra tilbakekobling."
        caption="Skal vise at banen er utløser, mens albedo og CO₂ er forsterkere. ID: fig-istid-faktorer."
      />
      ...
      <FigurePlaceholder
        id="fig-glasial-tidslinje"
        heading="Figurplass: glacialer og mellomistider"
        label="Tidslinje de siste 800 000 år: åtte sykluser, merket Elster / Saale / Weichsel der det passer, LGM ca. 21 000 år, holocen fra 11 700 år. Vis også at vi fortsatt er i kvartært ishus."
        caption="Skal skille ishus (lang skala) fra glacial/interglacial (kort skala). ID: fig-glasial-tidslinje."
      />

      <FigurePlaceholder
        id="fig-weichsel-utbredelse"
        heading="Figurplass: weichsel-isen over Norden"
        label="Kart over Fennoskandisk isdekke ved siste glacialmaksimum: is over Norge, Sverige, Finland og ut i Nordsjøen og Barentshavet. Merk isskillet og at kysten av Vestlandet kunne ha isfri lommer til ulike tider."
        caption="Skal vise utbredelsen ved LGM, ikke dagens breer. ID: fig-weichsel-utbredelse."
      />
      ...
      <FigurePlaceholder
        id="fig-istidsspor"
        heading="Figurplass: landformer etter weichsel"
        label="Én plansje med små snitt: skuringsstriper og rundsva, U-dal mot V-dal, endemorene / Raet, flyttblokk, drumlin og esker, marin grense med gammel strandlinje."
        caption="Skal samle erosjons- og avsetningsspor plus marin grense. ID: fig-istidsspor."
      />
