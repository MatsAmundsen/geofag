...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Læringsnettsted for Geofag 1 og Geofag 2: naturfarer, platetektonikk, vind, hav, klima.",
      },
  ...
  component: () => (
    <html lang="nb" className="antialiased" suppressHydrationWarning>
      <head>
        <HeadContent />
      </head>
      <body>
